 ...
 */
public class UnidadeProdutoForm extends javax.swing.JInternalFrame {

    private DefaultTableModel tabelaModelo;
    private Integer sizeTab = 1145;
    private UnidadeProdutoCon unidadeProdutoCon = new UnidadeProdutoCon();

    private static UnidadeProdutoForm testeframe;

    public static UnidadeProdutoForm getInstancia() {
        if (testeframe == null) {
            testeframe = new UnidadeProdutoForm();
        }
        return testeframe;
    }

    public UnidadeProdutoForm() {
        initComponents();
        setResizable(false);
    ...
    public void readJTable() {
        ...
        for (UnidadeProduto unidadeProduto : unidadeProdutoCon.getLista()) {
            tabelaModelo.addRow(new Object[]{
                unidadeProduto.getIdUnidade(),
                unidadeProduto.getDsUnidade(),
                unidadeProduto.getStUnidade()
            });
        }
    }
    ...
    public void readJTableForDescricao() {
        ...
        for (UnidadeProduto unidadeProduto : unidadeProdutoCon.getUnidadeProdutoPorNome(txfPesquisar.getText().toUpperCase())) {
            tabelaModelo.addRow(new Object[]{
                unidadeProduto.getIdUnidade(),
                unidadeProduto.getDsUnidade(),
                unidadeProduto.getStUnidade()
    ...
    public void readJTableForID() {
        ...
        for (UnidadeProduto unidadeProduto : unidadeProdutoCon.getUnidadeProdutoPorID(Integer.parseInt(txfPesquisar.getText()))) {
            tabelaModelo.addRow(new Object[]{
                unidadeProduto.getIdUnidade(),
                unidadeProduto.getDsUnidade(),
                unidadeProduto.getStUnidade()
    ...
    public void readJTableForSituacao() {
        ...
        for (UnidadeProduto unidadeProduto : unidadeProdutoCon.getUnidadeProdutoPorSituacao(txfPesquisar.getText())) {
            tabelaModelo.addRow(new Object[]{
                unidadeProduto.getIdUnidade(),
                unidadeProduto.getDsUnidade(),
                unidadeProduto.getStUnidade()
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Manutenção de Unidade Produto");
...
//        }
    ...
    private void bntNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNovoActionPerformed
            NovoGeralForm janelaNovo = new NovoGeralForm("Unidade","Novo");
            janelaNovo.setTitle("Nova Unidade Produto");
            janelaNovo.setModal(true);
            janelaNovo.setLocationRelativeTo(null);
            janelaNovo.setVisible(true);

            UnidadeProduto unidadeProduto = janelaNovo.getNovoUnidadeProduto();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (tabela.getSelectedRow() != -1) {
            UnidadeProduto unidadeProduto = unidadeProdutoCon.getUnidadeProduto((Integer) tabela.getValueAt(tabela.getSelectedRow(), 0));

            NovoGeralForm janela = new NovoGeralForm("Unidade", "Altera") {};
            janela.setTitle("Alterar Unidade Produto");
            janela.setModal(true);
            janela.setLocationRelativeTo(null);
            janela.setUnidadeProdutoAlterar(unidadeProduto);
            janela.setVisible(true);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (tabela.getSelectedRow() != -1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Deseja realmente excluir?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
                UnidadeProduto obj = unidadeProdutoCon.getUnidadeProduto(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString()));
                unidadeProdutoCon.excluir(obj);
