...
public class ProdutoForm extends javax.swing.JInternalFrame {
    ...
    private static ProdutoForm testeframe;

    public static ProdutoForm getInstancia() {
        if (testeframe == null) {
            testeframe = new ProdutoForm();
        }
        return testeframe;
    }
    ...
    public ProdutoForm() {
        initComponents();
        setResizable(false);
        tabela.setModel((new DefaultTableModel(null, new Object[]{"Código", "Descrição", "Quantidade", "Valor", "Marca", "Situação"})));
        tamanho_colunas();
    }
    ...
    private void tamanho_colunas() {
        ...
        modeloDaColuna.getColumn(2).setMaxWidth((sizeTab * 10) / 100);
        modeloDaColuna.getColumn(3).setMaxWidth((sizeTab * 10) / 100);
        modeloDaColuna.getColumn(4).setMaxWidth((sizeTab * 15) / 100);
        modeloDaColuna.getColumn(5).setMaxWidth((sizeTab * 15) / 100);
    }
